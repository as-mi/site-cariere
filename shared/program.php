<?php
    ...
    class program_object {
        ...
        static $event_templates_no_link = array(
            '<li class="na"><i class="bx bx-x" style="margin-top: 3px"></i><a style="text-decoration: none" class="text-muted"><span>%s</span></a></li>',
            '<li><i class="bx bx-timer text-danger" style="margin-top: 2px"></i><a style="color: var(--primary-8)"><span>%s</span></a></li>',
            '<li><i class="bx bx-time-five" style="margin-top: 3px"></i><a style="color: var(--primary-8)"><span>%s</span></a></li>'
        );
        static $event_templates = array(
            '<li class="na"><i class="bx bx-x" style="margin-top: 3px"></i><a href="%s" style="text-decoration: none" class="text-muted"><span>%s</span></a></li>',
            '<li><i class="bx bx-timer text-danger" style="margin-top: 2px"></i><a href="%s"><span>%s</span></a></li>',
            '<li><i class="bx bx-time-five" style="margin-top: 3px"></i><a href="%s"><span>%s</span></a></li>'
        );
        ...
        static function draw_events() {
            foreach (program_object::$current_program['events'] as $event) {
                ...
                if(isset($event['url']) && $event['url'])
                    ...
                    echo sprintf(program_object::$event_templates_no_link[$decision], $event['title'].' - '.$event['start'].' : '.$event['end']);
            }
        }
        ...
        static function draw_curent_events_shortcuts() {
            ...
            for ($i = 0; $i < $events_count; $i++) {
                ...
                if(isset($event['url']) && $event['url'])
                    ...
                    echo sprintf("<a style='color: var(--primary-8)'>%s</a>%s", $event['title'], $delimiter);
            }
        }
    }
?>